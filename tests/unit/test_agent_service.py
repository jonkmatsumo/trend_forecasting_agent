...
class TestLangGraphAgentService:
    ...
    def test_service_attributes(self):
        ...
        assert hasattr(self.agent_service, 'graph_agent')
        assert hasattr(self.agent_service, 'process_query')
        assert hasattr(self.agent_service, '_format_error_response')
        
        # Check that graph_agent is callable
        assert callable(self.agent_service.graph_agent) 